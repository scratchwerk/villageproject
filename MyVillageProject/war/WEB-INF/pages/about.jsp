...
<html class="no-js" lang="en-US">
	...
	<head>
		...
		<title>MyVillage Project - About Us</title>
				...
				<section id="content">
					...
					<article class="post page">
						<section class="main clear">
							<h1 class="title">It always took a village...</h1>
							<div class="content">
								<blockquote>This is a deep quote that brings to thought the urgency to come together as a community to uplift one another</blockquote>
								...
								<p><a href="admin/extra_login.html"><button class="icon-32" style="background-image: url(data/img/icons/32/sign-in.png);">Sign in</button></a></p>
								<hr />
