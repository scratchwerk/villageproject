...
<html class="no-js" lang="en-US">
	...
	<head>
		...
		<title>MyVillage Project - Photos</title>
...
<!-- // Main navigation -->
				...
				<section id="content">
					...
					<section class="filter">
						<a href="#">all</a>
						<a href="#video">Mentoring</a>
						<a href="#graphics">Community Service</a>
						<a href="#webdesign">Education</a>
						<a href="#photography">Organized Action</a>
					</section>
					<!-- // Filter -->
						...
						<article class="item" data-category="graphics photography">
							<div class="image">
								<a href="portfolio_item_slider.html">
									<img src="/" data-src="content/item14.jpg" class="responsive" alt="" />
