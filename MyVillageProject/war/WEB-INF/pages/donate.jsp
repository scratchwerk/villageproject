...
<html class="no-js" lang="en-US">
	...
	<head>
		...
		<title>MyVillage Project - Donate</title>
				...
				<nav id="nav-main" class="clear left">
					<ul>
						...
						<li>
							...
							<ul>
								<li>
									<a href="banners_full.html" title="sliders">Events</a>
									<ul>
										<li><a href="banners_full.html" title="full width slider">One-Time Events</a></li>
										<li><a href="banners_one_two.html" title="slider + two banners">Clubs</a></li>
										<li><a href="banners_one_text.html" title="slider + text">Support Services</a></li>
									</ul>
								</li>
								<li><a href="gallery_tiny.html" title="Photos">Photos</a></li>
								<li><a href="blog.html" title="Articles">Articles</a></li>
								<li><a href="portfolio_tiny_one.html" title="Awards">Awards</a></li>
							</ul>
						</li>
						<li>
							<a href="portfolio_small_one.html" title="Portfolios">MyVillage</a>
							<!--<ul>
								<li>
				...
				<section id="content">
					...
					<article class="post page">
						<section class="main clear">
							<h1 class="title">Donate to your favorite organization</h1>
							<div class="content">
								<blockquote>Nullam nulla eros, ultricies sit amet, nonummy id, imperdiet feugiat, pede. Sed lectus. Donec mollis hendrerit risus. Phasellus nec sem in justo pellentesque facilisis.</blockquote>
								
								
								<hr />

								<figure class="thin alignleft full-width-mobile" style="width: 60%;">
									<a href="content/photo02.jpg" title="Place for credits" class="fancybox"><img src="/" data-src="content/photo02.jpg" alt="" class="responsive" /></a>
									<figcaption>Place for credits</figcaption>
								</figure>
								<p><span class="dropcap">S</span>ullam dictum felis eu pede mollis pretium. Integer tincidunt. Cras dapibus. Vivamus elementum semper nisi. Aenean vulputate eleifend tellus. Aenean leo ligula, porttitor eu, consequat vitae, eleifend ac, enim. Aliquam lorem ante, dapibus in, viverra quis, feugiat a, tellus. Phasellus viverra nulla ut metus varius laoreet. Quisque rutrum. Aenean imperdiet.</p>
								<p class="gte-tablet"><span class="dropcap">N</span>am eget dui. Etiam rhoncus. Maecenas tempus, tellus eget condimentum rhoncus, sem quam semper libero, sit amet adipiscing consequat sem neque sed ipsum. <mark>This paragraph is invisible on mobile phones, and small smartphones.</mark> Nam quam nunc, blandit vel, luctus pulvinar, hendrerit id, lorem. Maecenas nec odio et ante tincidunt tempus. Donec vitae sapien ut libero venenatis faucibus. Nullam quis ante. Etiam sit amet orci eget eros faucibus tincidunt. Duis leo. Fusce vulputate eleifend sapien. Vestibulum purus quam, scelerisque ut, mollis sed, nonummy id, metus. Nullam accumsan lorem in dui. Cras ultricies mi eu turpis hendrerit fringilla. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia Curae; In ac dui quis mi consectetuer lacinia. Nam pretium turpis et arcu.</p>

								<p><button class="icon-32" style="background-image: url(data/img/icons/32/sign-in.png);">Button</button></p>
								<hr />
								...
								<div class="columns">
									<div class="column col-1-2">
										...
										<div class="tabs">
											...
											<div>
												<p>Aenean leo ligula, porttitor eu, consequat vitae, eleifend ac, enim. Aliquam lorem ante, dapibus in, viverra quis, feugiat a, tellus. Phasellus viverra nulla ut metus varius laoreet. <a href="#_">This is link</a>. Quisque rutrum. Aenean imperdiet. Etiam ultricies nisi vel augue. Curabitur ullamcorper ultricies nisi. Nam eget dui. Etiam rhoncus. Maecenas tempus, tellus eget condimentum rhoncus, sem quam semper libero, sit amet adipiscing sem neque sed ipsum. Nam quam nunc, blandit vel, luctus pulvinar, hendrerit id, lorem. Maecenas nec odio et ante tincidunt tempus. Donec vitae sapien ut libero venenatis faucibus.</p>
											</div>
											<div>
									...
									<div class="column col-1-4">
										...
										<p>Example list with icons:</p>
										<ul class="list check">
											<li>cras ultricies</li>
											<li>turpis hendrerit fringilla</li>
											<li>vestibulum ante ipsum</li>
											<li>primis in faucibus orci</li>
											<li>luctus et ultrices posuere</li>
											<li>cubilia mi consectetuer</li>
											<li>nam pretium turpis</li>
											<li>duis arcu tortor</li>
										</ul>

									

									</div>
									<div class="column col-1-4 last">

										<p>There are <strong>100 predefined icons</strong> for this purpose. Another example:</p>
										<ul class="list star">
											<li>cras ultricies</li>
											<li>turpis hendrerit fringilla</li>
											<li>vestibulum ante ipsum</li>
								...
								<p class="frame blue icon-32" style="background-image: url(data/img/icons/32/plus.png);">
									Donec posuere vulputate arcu. <a href="#_">Phasellus</a> accumsan cursus velit. Vestibulum ante ipsum primis in faucibus orci luctus et ultrices posuere cubilia. Sed cursus turpis vitae tortor. Donec posuere vulputate arcu. Phasellus accumsan cursus velit.
								</p>
