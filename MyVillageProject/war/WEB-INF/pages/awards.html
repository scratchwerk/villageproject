...
<html class="no-js" lang="en-US">
	...
	<head>
		...
		<title>MyVillage Project - Awards</title>
...
<!-- // Main navigation -->
				...
				<section id="content">
					...
					<section class="filter">
						<a href="#">all</a>
						<a href="#video">Student of the Month</a>
						<a href="#graphics">Scholar Athletes</a>
						<a href="#webdesign">Acedemics</a>
						<a href="#photography">Arts</a>
					</section>
					<!-- // Filter -->
					...
					<section class="items tiny clear">
						...
						<article class="item" data-category="graphics photography">
							<div class="image">
								<a href="award_item.html">
									<img src="/" data-src="content/item01.jpg" class="responsive" alt="" />
									<span class="hover"></span>
								</a>
							</div>
							<section class="main">
								<h1 class="title"><a href="award_item.html" title="Optional title">Optional title</a></h1>
								<div class="content">
						...
						<article class="item" data-category="video">
							...
							<section class="main">
								<h1 class="title"><a href="award_item.html" title="Another title">Another title</a></h1>
								<div class="content">
						...
						<article class="item" data-category="webdesign">
							...
							<section class="main">
								<h1 class="title"><a href="award_item.html" title="Sed consequat bibendum">Sed consequat bibendum</a></h1>
								<div class="content">
						...
						<article class="item" data-category="photography">
							...
							<section class="main">
								<h1 class="title"><a href="award_item.html" title="Super cool title">Super cool title</a></h1>
								<div class="content">
						...
						<article class="item" data-category="photography">
							...
							<section class="main">
								<h1 class="title"><a href="award_item.html" title="Aenean imperdiet">Aenean imperdiet</a></h1>
								<div class="content">
						...
						<article class="item" data-category="webdesign">
							...
							<section class="main">
								<h1 class="title"><a href="award_item.html" title="Consequat vitae">Consequat vitae</a></h1>
								<div class="content">
						...
						<article class="item" data-category="graphics photography">
							...
							<section class="main">
								<h1 class="title"><a href="award_item.html" title="Curabitur ullamcorper">Curabitur ullamcorper</a></h1>
								<div class="content">
